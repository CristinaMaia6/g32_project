            ...
            if op == 'b':
                ...
                for i in range(1, len(str_list)):
                    ...
                    while True:
                        ...
                        # validar negativos
                        if value != "" and atype in [int, float]:
                        ...
                        if atype == int and value != "":

                            v = int(value)

                            if "farmer" in attrib.lower():

                                if v not in Farmer.lst:
                                    print("Erro: Farmer inexistente.")
                                    continue

                            elif "market" in attrib.lower() and "type" not in attrib.lower():

                                if v not in Market.lst:
                                    print("Erro: Market inexistente.")
                                    continue

                            elif "worker" in attrib.lower():

                                if v not in Worker.lst:
                                    print("Erro: Worker inexistente.")
                                    continue

                            elif "type" in attrib.lower():

                                if v not in MarketType.lst:
                                    print("Erro: MarketType inexistente.")
                                    continue
